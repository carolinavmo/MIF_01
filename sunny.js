...
function addScore(btn) {
  ...
  simetria_repouso = score1 + score2 + score3
  simetria_repouso_total = simetria_repouso * 5
  
  simetria_movimento = score4 + score5 + score6 + score7 + score8
  simetria_movimento_total = simetria_movimento * 4

  sincinesia = score9 + score10 + score11 + score12 + score13
  
  aa = simetria_repouso_total + sincinesia
  sunny_score = simetria_movimento_total - aa
...
function showResults() {
  if (
    ...
    console.log(total)
    result.innerHTML = `
    <b>Escala de Sunnybrook</b>
    <p> - Simetria em repouso = (${score1} + ${score2} + ${score3}) X 5 = ${simetria_repouso_total} pontos</p>
    <p> - Simetria dos movimentos voluntários = (${score4} + ${score5} + ${score6} + ${score7} + ${score8}) X 4 = ${simetria_movimento_total} pontos</p>
    <p> - Sincinésias = ( ${score9} + ${score10} + ${score11} + ${score12} + ${score13}) = ${sincinesia} pontos</p>    
    <b>Score total de Sunnybrook = (${simetria_movimento_total} - ${simetria_repouso_total} - ${sincinesia}) = ${sunny_score} pontos </b>
    `;
  }
