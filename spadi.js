...
function addScore(btn) {
  total = score1 + score2 + score3 + score4 + score5 + score6 + score7 + score8 + score9 + score10 + score11 + score12 + score13;
  total_a = total / 130
  spadi_percentage = total_a * 100


  dor = score1 + score2 + score3 + score4 + score5 
  dor_a = dor / 50
  dor_percentage = dor_a * 100

  incapacidade = score6 + score7 + score8 + score9 + score10 + score11 + score12 + score13; 
  incapacidade_a = incapacidade / 80
  incapacidade_percentage = incapacidade_a * 100
...
function showResults() {
  if (
    ...
    result.innerHTML = `
    <p> 
    <b>SPADI Score = ${spadi_percentage.toFixed(1)} % </b></p>
    <p>- Total pain score: ${dor_percentage.toFixed(1)} % ( ${score1} + ${score2} + ${score3} + ${score4} + ${score5} = ${dor})</p>
    <p>- Total disability score: ${incapacidade_percentage.toFixed(1)} % (${score6} + ${score7} + ${score8} + ${score9} + ${score10} + ${score11} + ${score12} + ${score13} = ${incapacidade}) <br></p>
    
    <p>( ${score1} + ${score2} + ${score3} + ${score4} + ${score5} + ${score6} + ${score7} + ${score8} + ${score9} + ${score10} + ${score11} + ${score12} + ${score13} = ${total} )</p>
