...
function showResults() {
  if (
    ...
    console.log(total)
    result.innerHTML = `
    <p><b>HOOS-12 Score = ${hoos_12.toFixed(1)} % </b></p>
    <p>- Dor: ${dor_hoos} % (${score1} + ${score2} + ${score3} + ${score4}  = ${dor_total} pts) </p>
    <p>- Função: ${funcao_hoos} % (${score5} + ${score6} + ${score7} + ${score8} = ${funcao_total} pts) </p>
    <p>- Qualidade de vida: ${qualidade_hoos} % (${score9} + ${score10} + ${score11} + ${score12} = ${qualidade_total} pts) </p>
