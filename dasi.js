...
function showResults() {
  if (
    ...
    console.log(total)
    result.innerHTML = `
    <p><b>DASI Score = </b>(${score1} + ${score2} + ${score3} + ${score4} + ${score5} + ${score6} + ${score7} + ${score8} + ${score9} + ${score10} + ${score11} + ${score12}) = ${total} pontos  </p>
...
buttons1.forEach((btn) => {
  btn.addEventListener("click", (e) => {
    ...
    addClass(btn);
    score1 = parseFloat(btn.dataset.value, 10);
    console.log(score1)
    addScore(btn);
    showResults();
  });
...
buttons2.forEach((btn) => {
  btn.addEventListener("click", (e) => {
    ...
    addClass(btn);
    score2 = parseFloat(btn.dataset.value, 10);
    addScore(btn);
    showResults();
  });
});
...
buttons3.forEach((btn) => {
  btn.addEventListener("click", (e) => {
    ...
    addClass(btn);
    score3 = parseFloat(btn.dataset.value, 10);
    addScore(btn);
    showResults();
  });
});
...
buttons4.forEach((btn) => {
  btn.addEventListener("click", (e) => {
    ...
    addClass(btn);
    score4 = parseFloat(btn.dataset.value, 10);
    addScore(btn);
    showResults();
  });
});
...
buttons5.forEach((btn) => {
  btn.addEventListener("click", (e) => {
    ...
    addClass(btn);
    score5 = parseFloat(btn.dataset.value, 10);
    addScore(btn);
    showResults();
  });
});
...
buttons6.forEach((btn) => {
  btn.addEventListener("click", (e) => {
    ...
    addClass(btn);
    score6 = parseFloat(btn.dataset.value, 10);
    addScore(btn);
    showResults();
  });
});
...
buttons7.forEach((btn) => {
  btn.addEventListener("click", (e) => {
    ...
    addClass(btn);
    score7 = parseFloat(btn.dataset.value, 10);
    addScore(btn);
    showResults();
  });
});
buttons8.forEach((btn) => {
  btn.addEventListener("click", (e) => {
    ...
    addClass(btn);
    score8 = parseFloat(btn.dataset.value, 10);
    addScore(btn);
    showResults();
  });
});
...
buttons9.forEach((btn) => {
  btn.addEventListener("click", (e) => {
    ...
    addClass(btn);
    score9 = parseFloat(btn.dataset.value, 10);
    addScore(btn);
    showResults();
  });
});
...
buttons10.forEach((btn) => {
  btn.addEventListener("click", (e) => {
    ...
    addClass(btn);
    score10 = parseFloat(btn.dataset.value, 10);
    addScore(btn);
    showResults();
  });
});
...
buttons11.forEach((btn) => {
  btn.addEventListener("click", (e) => {
    ...
    addClass(btn);
    score11 = parseFloat(btn.dataset.value, 10);
    addScore(btn);
    showResults();
  });
});
...
buttons12.forEach((btn) => {
  btn.addEventListener("click", (e) => {
    ...
    addClass(btn);
    score12 = parseFloat(btn.dataset.value, 10);
    addScore(btn);
    showResults();
  });
});
