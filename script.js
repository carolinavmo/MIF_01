...
function showResults() {
 ...
 <u>AUTOCUIDADOS: </u>
   <p>- Alimentação: ${score1} </p>
   <p>- Higiene pessoal: ${score2} </p>
   <p>- Banho: ${score3} </p>
   <p>- Vestir metade superior: ${score4} </p> 
   <p>- Vestir metade inferior: ${score5}  </p>
   <p>- Utilização da sanita: ${score6} </p>
 
 <u>CONTROLO DE ESFINCTERES:</u>
  <p>- Controlo vesical: ${score7}  </p>
  <p>- Controlo intestinal: ${score8} </p> 
 
 <u>TRANSFERÊNCIAS:</u>
  <p>- Transferências (leito, cadeira, CR): ${score9} </p>
  <p>- Transferências (sanita): ${score10} </p>
  <p>- Transferências (banheira ou chuveiro): ${score11} </p> 
 
 <u>LOCOMOÇÃO:</u>
  <p>- Locomoção: ${score12} </p>
  <p>- Escadas: ${score13}  </p>
 
 <u>COMUNICAÇÃO:</u>
  <p>- Compreensão: ${score14} </p> 
  <p>- Expressão: ${score15} </p>
 
 <u>CONSCIÊNCIA DO MUNDO EXTERIOR:</u>
  <p>- Interação social: ${score16}</p>  
  <p>- Resolução de problemas: ${score17}</p> 
  <p>- Memória: ${score18}</p>`;
