...
function addScore(btn) {
  total = score1 + score3 + score5 + score7 
...
function showResults() {
  if (
    ...
    console.log(total)
    result.innerHTML = `
    <p><b>ICIQ-OAB Score = (${score1} + ${score3} + ${score5} + ${score7}) = ${total} </b> </p>
    <p> [3A: ${score1}, 3B: ${score2}, 4A: ${score3}, 4B: ${score4}, 5A: ${score5}, 5B: ${score6}, 6A: ${score7}, 6B: ${score8} ]  </p>
